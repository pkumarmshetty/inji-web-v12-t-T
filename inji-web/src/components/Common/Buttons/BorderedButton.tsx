...
export const BorderedButton:React.FC<BorderedButtonProps> = (props) => {
  return <div className={props.fullWidth ? "w-full" : ""}>
    <div className={"bg-gradient-to-r rounded-lg text-center cursor-pointer shadow hover:shadow-lg from-[--iw-color-primary] to-[--iw-color-secondary] p-0.5"} onClick={props.onClick}>
